...
git clone https://github.com/skethirajan/molanalysis.git
cd molanalysis
...
uv venv $SCRATCH/venvs/molanalysis

# Activate and install
source $SCRATCH/venvs/molanalysis/bin/activate
uv pip install -e ".[dev]"
...
# Run with coverage
pytest --cov=molanalysis --cov-report=html
...
- Mirror the source structure (e.g., `src/molanalysis/utils.py` → `tests/test_utils.py`).
